...
contextBridge.exposeInMainWorld("ytd", {
  ...
  switchFocus: (context: string) => ipcRenderer.send("ytView:switchFocus", context),
  ytViewNavigateDefault: () => ipcRenderer.send("ytView:navigateDefault"),
  ytViewRecreate: () => ipcRenderer.send("ytView:recreate"),
  memoryStore: {
