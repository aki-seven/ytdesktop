...
<template>
  <div :class="{ 'ytd-setting': true, 'indented': props.indented, 'flex-column': props.flexColumn }">
...
.ytd-setting.indented {
  margin-left: 12px;
  padding-left: 12px;
  border-left: 1px solid #212121;
}

.ytd-setting.flex-column {
  flex-direction: column;
  align-items: initial;
  justify-content: initial;
}

.ytd-setting .beta-tag {
  background-color: #f44336;
  border-radius: 4px;
  padding: 2px 4px;
}

.ytd-setting .disabled-tag {
