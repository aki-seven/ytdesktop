...
(function () {
  ...
  const ytmStore = window.__YTD_HOOK__.ytmStore;

  let ytdControlButtons = {};
  ...
  libraryButton.classList.add("ytd-player-bar-control");
  ...
  let libraryButtonData = {
    ...
    onTap: function () {
      ...
      window.__YTD_HOOK__.ytmStore.dispatch({
  ...
  playlistButton.classList.add("ytd-player-bar-control");
  ...
  sleepTimerButton.classList.add("ytd-player-bar-control");
  ...
  window.addEventListener("yt-action", e => {
    if (e.detail.actionName === "yt-service-request") {
      if (e.detail.args[1].ytdSleepTimerServiceEndpoint) {
        ...
        if (e.detail.args[1].ytdSleepTimerServiceEndpoint.time > 0) {
          if (!sleepTimerButton.classList.contains("active")) {
            sleepTimerButton.classList.add("active");
            sleepTimerButton.setAttribute("title", `Sleep timer ${humanizeTime(e.detail.args[1].ytdSleepTimerServiceEndpoint.time)}`);
          }
                      ...
                      popup: {
                        notificationActionRenderer: {
                          responseText: {
                            runs: [
                              {
                                text: `Sleep timer set to ${humanizeTime(e.detail.args[1].ytdSleepTimerServiceEndpoint.time)}`
                              }
                            ]
                          }
                        }
          ...
          sleepTimerTimeout = setTimeout(
            ...
            e.detail.args[1].ytdSleepTimerServiceEndpoint.time * 1000 * 60
          );
        } else {
          document.body.dispatchEvent(
            new CustomEvent("yt-action", {
  ...
  ytdControlButtons.libraryButton = libraryButton;
});
