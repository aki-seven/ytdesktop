  ...
  private UpdateActivity() {
    ...
    this.activityDebounceTimeout = setTimeout(() => {
      ...
      this.discordClient.setActivity({
        ...
        details_url: `https://www.youtube.com/watch?v=${id}`,
        state: stringLimit(author, 128, 2),
        state_url: `https://www.youtube.com/channel/${channelId}`,
        timestamps: {
        ...
        assets: {
          large_image: (thumbnail?.length ?? 0) <= 256 ? thumbnail : "ytd-logo",
          large_text: album ? stringLimit(album, 128, 2) : undefined,
          large_url: albumId ? `https://www.youtube.com/browse/${albumId}` : undefined,
