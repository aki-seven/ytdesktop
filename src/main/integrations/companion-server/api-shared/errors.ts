...
export const YouTubeUnavailableError = createError<[]>("YOUTUBE_UNVAILABLE", "YouTube is currently unvailable", 503);
export const YouTubeTimeOutError = createError<[]>("YOUTUBE_TIME_OUT", "Response from YouTube took too long", 504);
export const YouTubeMusicUnavailableError = createError<[]>("YOUTUBE_MUSIC_UNAVAILABLE", "YouTube Music is currently unavailable", 503);
