...
try {
  ...
  // User has likely downloaded from the YT Desktop via the "Download ZIP".
...
export default defineConfig({
  ...
  define: {
    YTD_GIT_COMMIT_HASH: JSON.stringify(gitCommitHash),
    YTD_GIT_BRANCH: JSON.stringify(gitBranch)
  }
});
